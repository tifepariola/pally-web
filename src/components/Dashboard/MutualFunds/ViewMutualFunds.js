...
class ViewMutualFunds extends Component {
  componentWillMount() {
    if (!Cookie.getAuth()) {
          ...
          <div className="container-fluid">
            ...
            <div className="row mt-2">
                    ...
                    <div className="row">
                      <div className="col-md-4 text-center">
                        <div className="p-3 pb-0">
                          <h5 className="text-muted font-weight-normal mt-0">Total Investment</h5>
                      ...
                      <div className="col-md-4 text-center">
                        <div className="p-3 pb-0">
                          <h5 className="text-muted font-weight-normal mt-0">Daily Price Change</h5>
              ...
              <div className={"col-xl-3"}>
                <div className="card widget-flat text-center mx-auto">
                  <div className="card-body">
                    <div className="row">
                      <div className="col-md-6">
                      <Link to="/">
                        <i className="fa fa-wallet fa-3x mb-2"></i>
                        <h5 className="text-muted font-weight-normal mt-0">Invest More</h5>
                      </Link>
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                      <Link to="/">
                        ...
                        <h5 className="text-muted font-weight-normal mt-0">Sell Plan</h5>
                      </Link>
                    </div>
                    </div>
                  </div>
              ...
              <div className={"col-xl-9"}>
                <div className="card" style={{height: "calc(100% - 30px)"}}>
                  <div className="card-body">
                    <h4 className="header-title">Fund Details</h4>
